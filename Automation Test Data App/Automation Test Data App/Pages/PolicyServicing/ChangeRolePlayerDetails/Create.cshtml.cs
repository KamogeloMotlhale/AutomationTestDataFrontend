...
namespace Automation_Test_Data_App.Pages.PolicyServicing.ChangeLifeData
{
    public class CreateModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            ChangeLifeDataInfo.id = scenarioID;
        }
        ...
        public void OnPost()
        {
            ...
            try 
            {
                ...
                {
                    connection.Open();
                    String sql = "INSERT INTO ChangeRolePlayerDetails " +
                                "(Scenario_ID ,Title, Surname, MaritalStatus, EducationLevel, Department, Profession , Roleplayer, RolePlayer_idNum) VALUES" +
                                "(@id,@Title, @Surname, @MaritalStatus, @EducationLevel, @Department, @Profession, @Roleplayer, @RolePlayer_idNum);";
                    ...
                    ChangeLifeDataInfo.Department = ""; ChangeLifeDataInfo.RolePlayer_idNum = ""; ChangeLifeDataInfo.Roleplayer = "";
